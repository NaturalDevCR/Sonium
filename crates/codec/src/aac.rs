...
use symphonia_core::codecs::{
    CodecParameters, Decoder as SymphDecoder, DecoderOptions, CODEC_TYPE_AAC,
};
...
impl AacDecoder {
    pub fn from_header(data: &[u8]) -> Result<Self> {
        ...
        let inner =
            SymphAacDecoder::try_new(&params, &DecoderOptions::default()).map_err(symp_err)?;
