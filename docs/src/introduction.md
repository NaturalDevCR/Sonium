...
- **Announcement control plane and ducking** — authenticated, idempotent
  intents with priority arbitration and synchronized client-side duck envelopes.
  Direct URI fetch/decode remains a follow-up (see [Music Assistant /
  Announcements](./integrations/music-assistant.md)).
